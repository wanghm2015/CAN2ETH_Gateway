...
#define configSYSCALL_CALL_DEPTH            2    //modified by whm, from 2 to 0
...
#define IFX_CFG_CPU_TRAP_SYSCALL_CPU0_HOOK vPortSyscallHandler    //modified by whm, from vPortSyscallYield to vPortSyscallHandler
